...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        a life estate.
    \end{enumerate}
    % TODO: notes and questions on pp. 208-09
\end{enumerate}
...
\begin{enumerate}
    ...
    financial need.
    % TODO: notes and questions p. 215.
\end{enumerate}
...
\begin{enumerate}
    \item Technically, leasehold tenants do not have seisin, but the 
    distinction between possession and seisin is irrelevant in most modern 
    contexts.\footnote{Casebook p. 222.}
\end{enumerate}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            determination)---% TODO 225 top
        \end{enumerate}
        \item \textbf{Fee simple subject to executory limitation}: % TODO 225
        \begin{enumerate}
            \item \emph{Future interest}: \textbf{executory interest}---
            % TODO 225
        \end{enumerate}
    \end{enumerate}
\end{enumerate}
