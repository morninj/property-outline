...
\begin{enumerate}
    ...
    an easement rather than a possessory right).
    \begin{enumerate}
        ...
        one parcel to access the other. In this case, Hill owned Othen's and 
        the Rosiers' land as well as the surrounding land. Upon severance, 
        there might have been several other ways to access Othen's lot. Othen 
        failed to show that the road on the Rosiers' lot was \emph{necessary}, 
        rather than merely \emph{convenient}.\footnote{Casebook p. 789.}
    ...
    \end{enumerate}
    \item Othen did not have an easement. Affirmed.
\end{enumerate}
