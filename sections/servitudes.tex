...
\begin{enumerate}
    \item The benefit of an easement appurtenant automatically transfers. The 
    burden also automatically transfers unless (1) the transferee qualifies 
    for protection against the express easement as a bona fide purchaser or 
    (2) the owner of the dominant tenement agrees to release the easement.
    \item Easements in gross are generally freely transferable, although 
