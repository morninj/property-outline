...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        run.\footnote{For policy issues, see p. 875.} % TODO
        ...
        enforceable).
            % TODO: does this apply to both real covenant and equitable 
            % servitudes? 
        \begin{enumerate}
...
\begin{enumerate}
    ...
    mutual interests, successive interest, or no horizontal privity required).
        % TODO: verify with sprankling, which says no notice
...
\begin{enumerate}
    ...
    functional use? % TODO see crane neck, where the plaintiff ultimately 
...
\begin{enumerate}
    ...
    \item % TODO: add `a policy analysis of promises respecting the use of 
    % land' (reader)
    \item % TODO add `toward a unified conception of servitudes' (reader)
    \item % TODO: toward a modern law of servitudes: reweaving the ancient 
    % strands (reader)
\end{enumerate}
...
\begin{enumerate}
    ...
    \item % TODO policy question p. 876 -- third-party beneficiaries
\end{enumerate}

\subsubsection{\emph{Old Dominion Iron \& Steel Corp. v. Virginia Electric \& 
Power Co.}}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \emph{benefit} is in gross. % TODO see caullett; and verify that this 
        % is the same issue that arises with the burden of a real covenant
    \end{enumerate}
...
\begin{enumerate}
    ...
    land. The burden can be in gross. % TODO verify, and see caullett
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            \item Writing? Yes.
            \item Intent? Yes. % TODO why?
            \item Touch and concern? Yes. % TODO why?
