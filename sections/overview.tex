...
\begin{enumerate}
    ...
    possibility of reverter and right of entry. % TODO others?
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            are not.
            \begin{enumerate}
                \item \textbf{Inchoate dower}: while the husband is alive, the 
                wife has an interest in property eligible for dower. He can't 
                transfer it without her consent, nor can creditors reach it. 
                Applied only to real property.
            \end{enumerate}
            \item \textbf{Curtesy}: the husband gets a full life estate in the 
            wife's freehold property (FSA, fee tail), but only if the marriage 
            produced issue (to give husbands an incentive to procreate).
            \item Both have been successfully challenged as violating equal 
            protection. Dower and curtesy exists in only four states, and in 
            three of them curtesy has been abolished and dower has been 
            extended to husbands.
        \end{enumerate}
        \item \textbf{Elective forced share}:
        \begin{enumerate}
            \item The surviving spouse can (1) abide by the decedent's will or 
            (2) take a share of the decedent's property (usually half or a 
            third).
            \item In some states, the share varies with the duration of the 
            marriage.
            \item Loophole: it does not apply to property that the decedent 
            conveyed while still alive, even if conveyed a day before death.
        \end{enumerate}
    \end{enumerate}
    \item \textbf{Termination of marriage by divorce}:
    \begin{enumerate}
        \item Common law: 
        \begin{enumerate}
            \item Property was divided according to who held title.
            \item If the wife wasn't at fault, she could collect alimony for 
            life.
        \end{enumerate}
        \item Today, all common law states (i.e., not community property) use 
...
\subsubsection{Delivery of Possession}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            \item \item \textbf{B and C}: privity of contract. % TODO p of e?
...
\subsubsection{Termination} % TODO
...
\paragraph{Surrender} % TODO
\paragraph{Abandonment} % TODO 
\paragraph{Landlord's Right to Terminate the Lease} % TODO 
\paragraph{Self-Help Eviction} % TODO 
\paragraph{Ejectment} % TODO 
\paragraph{Summary Eviction Proceedings} % TODO
\paragraph{Other Remedies Available to the Landlord} % TODO

\subsubsection{Condition of Leased Premises} % TODO

\paragraph{Common Law}
\paragraph{Quiet Enjoyment and Constructive Eviction} % TODO 
\paragraph{Illegal Lease} % TODO 
\paragraph{Implied Warranty of Habitability} % TODO 
\paragraph{Landlord Liability for Negligence and Exculpatory Clauses}
    % TODO

\subsubsection{The Problem of Decent Affordable Housing} % TODO
