...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item % TODO
    \end{enumerate}
    \item \textbf{Surrender} % TODO
    \item \textbf{Abandonment} % TODO 
    \item \textbf{Self-Help Eviction} % TODO 
    \item \textbf{Ejectment} % TODO 
    \item \textbf{Summary Eviction Proceedings} % TODO
    \item \textbf{Other Remedies Available to the Landlord} % TODO
\end{enumerate}

\subsubsection{Condition of the Leased Premises} % TODO

\paragraph{Common Law} % TODO
