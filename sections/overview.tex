...
\begin{enumerate}
    ...
    \item % TODO privity of estate and contract; add examples
\end{enumerate}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item (`Landlord's Remedies in Addition to Eviction') % TODO
    \end{enumerate}
    \item \textbf{Tenant who has abandoned possession}:
    \begin{enumerate}
        \item (Whitehorn v. Dickerson) % TODO 
        ...
        \item (`Landlord's Remedies and Security Devices') % TODO
    \end{enumerate}
\end{enumerate}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item (Whitehorn v. Dickerson) % TODO
        \item (Ingalls v. Hobbs) % TODO
        \item (Peterson v. Superior Court) % TODO
        \item (`Landlord Liability for Negligence and Exculpatory Clauses') 
            % TODO
        \item (Bruckner v. Helfaer) % TODO
    ...
    \begin{enumerate}
        ...
        \item (Hilder v. St. Peter) % TODO
        \item (499 - 503 (note 5)) % TODO 
        \item ('notes on the implied warranty' in supp) % TODO
        \item (`Cities Deal with a Surge in Shantytowns') % TODO
        \item (`Edwards v. Habib') % TODO
    \end{enumerate}
\end{enumerate}
